    ...
    def context(self, *arg):
        ...
        try:
           ...
           if self.pyInteractMode == True:
               #msg("call father context")
               super(ArmPEDACmd, self).context(*arg)
    ...
    def _beautiful_code(self, pc, count):
        ...
        if inst:  # valid $PC
            ...
            # stopped at other instructions
                ...
                if 'svc' in opcode:
                    text += "\n"
                    text += self._get_syscall()
                return text 
        else:  # invalid $PC
            return ("Invalid $PC address: 0x%x" % pc, "red")
...
if __name__ == '__main__':
    ...
    PEDA.execute("set prompt %s" % red(""))  # custom prompt
